...
func drawDebugScreen(imd *imdraw.IMDraw) {
	...
	basePosition := Global.ScreenHeight * (1 - Global.SizeYused)	// Value reserved for debug on screen

	// -------------------------- Draw Debug Rectangle -------------------------- //
	// Background
	imd.Color = colornames.Bisque
	imd.Push(pixel.V ( 0 , 0  ) )
	imd.Push(pixel.V ( Global.ScreenWidth , basePosition ) )
	imd.Rectangle(0)
	...
	imd.Push(pixel.V ( Global.ScreenWidth , basePosition -2 ) )
	imd.Rectangle(0)
	// Down bar
	imd.Push(pixel.V ( 0 , 0  ) )
	imd.Push(pixel.V ( Global.ScreenWidth , 2 ) )
	imd.Rectangle(0)
	// Left bar
	imd.Push(pixel.V ( 0 , 0  ) )
	...
	imd.Rectangle(0)
	// Right bar
	imd.Push(pixel.V ( Global.ScreenWidth , 0  ) )
	imd.Push(pixel.V ( Global.ScreenWidth -2 , basePosition ) )
	imd.Rectangle(0)
