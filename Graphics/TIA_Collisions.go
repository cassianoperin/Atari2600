...
var (
	...
	CD_P0_sprite_copy		uint16	= 0		// P0 copy of the sprite after NUSIZ transformation
	CD_P1_sprite_size		uint8	= 0		// P1 size of the sprite after NUSIZ transformation
	CD_P1_sprite_copy		uint16	= 0		// P1 copy of the sprite after NUSIZ transformation
)

func CollisionDetectionP0_P1() {
	var collision_test uint16
