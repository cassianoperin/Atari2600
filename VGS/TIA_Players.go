...
func drawPlayer(player byte) {
	...
	if player == 0 {
		...
		if debugGraphics {
			fmt.Printf("Line: %d\tGRP0: %08b\tXPositionP0: %d\tHMP0: %d\n", line, Memory[GRP0], XPositionP0, Memory[HMP0])
		}

		register_REFP	= Memory[REFP0]
		register_GRP	= Memory[GRP0]
		register_COLUP	= Memory[COLUP0]
		register_NUSIZ	= Memory[NUSIZ0]
	...
	// Configs for Drawing P1
		...
		if debugGraphics {
			fmt.Printf("Line: %d\tGRP1: %08b\tXPositionP1: %d\tHMP1: %d\n", line, Memory[GRP1], XPositionP1, Memory[HMP1])
		}

		register_REFP	= Memory[REFP1]
		register_GRP	= Memory[GRP1]
		register_COLUP	= Memory[COLUP1]
		register_NUSIZ	= Memory[NUSIZ1]
	...
	// ----- Draw Player Line ----- //
	//screenHeight * (1 - sizeYused))  used to add the draw to the top of screen
	...
	for i:=0 ; i <=7 ; i++ {
		...
		if bit == 1 {
			...
			if register_NUSIZ == 0x00 {
				...
				imd.Push(pixel.V( (float64( drawLinePosition ) ) * width				, (screenHeight * (1 - sizeYused)) + drawLine * height ))
				imd.Push(pixel.V( (float64( drawLinePosition ) ) * width + width		, (screenHeight * (1 - sizeYused)) + drawLine * height + height))
				imd.Rectangle(0)
			...
			// ----------------------------------------------- NUSIZx = 0x01 ----------------------------------------------- //
				...
				imd.Push(pixel.V( (float64( drawLinePosition ) ) * width + width	, (screenHeight * (1 - sizeYused)) + drawLine * height + height))
				imd.Rectangle(0)
				imd.Push(pixel.V( (float64( drawLinePosition2) ) * width		, (screenHeight * (1 - sizeYused)) + drawLine * height ))
				imd.Push(pixel.V( (float64( drawLinePosition2) ) * width + width	, (screenHeight * (1 - sizeYused)) + drawLine * height + height))
				imd.Rectangle(0)
			...
			// ----------------------------------------------- NUSIZx = 0x03 ----------------------------------------------- //
				...
				imd.Push(pixel.V( (float64( drawLinePosition2 ) ) * width + width	, (screenHeight * (1 - sizeYused)) +  drawLine * height + height))
				imd.Rectangle(0)
				imd.Push(pixel.V( (float64( drawLinePosition3 ) ) * width		, (screenHeight * (1 - sizeYused)) +  drawLine * height ))
				imd.Push(pixel.V( (float64( drawLinePosition3 ) ) * width + width	, (screenHeight * (1 - sizeYused)) + drawLine * height + height))
				imd.Rectangle(0)
			...
			// ----------------------------------------------- NUSIZx = 0x07 ----------------------------------------------- //
				...
				imd.Push(pixel.V( (float64( drawLinePosition3) ) * width + width	, (screenHeight * (1 - sizeYused)) + drawLine * height + height))
				imd.Rectangle(0)
				imd.Push(pixel.V( (float64( drawLinePosition4) ) * width		, (screenHeight * (1 - sizeYused)) + drawLine * height ))
				imd.Push(pixel.V( (float64( drawLinePosition4) ) * width + width	, (screenHeight * (1 - sizeYused)) + drawLine * height + height))
				imd.Rectangle(0)
